...
* APEX Theme (update from 1.0.0 to 1.2.1): `Changelog 1.2.1 <https://github.com/OXID-eSales/apex-theme/blob/v1.2.1/CHANGELOG-1.x.md#v121---2024-01-15>`_
...
* WYSIWYG Editor + Mediathek module (update from 3.0.1 to 3.0.2): `Changelog 3.0.2 <https://github.com/OXID-eSales/ddoe-wysiwyg-editor-module/blob/v3.0.2/CHANGELOG.md#302---2023-11-22>`_
